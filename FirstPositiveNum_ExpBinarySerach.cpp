/***************************************************
 * Title : Find +ve breakpoint in a monotonically  increasing function
...
// Example monotonically increasing function : f(x) = x^2 - 10*x - 20
...
int main() {
  cout << "The value n where f() becomes positive first is: "
       << findFirstPositive() << endl;
  return 0;
}
